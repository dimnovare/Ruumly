...
public static class EmailTranslations
{
    ...
    private static readonly IReadOnlyDictionary<string, string> ScopeEt =
        WithSharedAccessChips(new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["vanrentalLicence.label"]      = "Juhiloa staaž",
            ["vanrentalLicence.opt1"]       = "Esmane juhiluba (alla 2 aasta)",
            ["vanrentalLicence.opt2"]       = "2–5 aastat",
            ["vanrentalLicence.opt3"]       = "Üle 5 aasta",
            ["vanrentalLicence.opt4"]       = "Klient võtab koos juhiga — ise ei sõida",
            ["vanrentalLicence.opt5"]       = "Klient ei ole kindel",
            ...
            ["cleaningArea.label"]          = "Pinna suurus",
            ["cleaningArea.opt1"]           = "Kuni 40 m² (1 tuba)",
            ["cleaningArea.opt2"]           = "40–60 m² (2 tuba)",
            ["cleaningArea.opt3"]           = "60–80 m² (3 tuba)",
            ["cleaningArea.opt4"]           = "80–110 m² (4 tuba)",
            ["cleaningArea.opt5"]           = "110–150 m²",
            ["cleaningArea.opt6"]           = "Üle 150 m² või maja",
            ["cleaningArea.opt7"]           = "Klient ei ole kindel",
            ["cleaningFrequency.label"]     = "Kui sageli",
            ["cleaningFrequency.opt1"]      = "Ühekordne koristus",
            ["cleaningFrequency.opt2"]      = "Kord nädalas",
            ["cleaningFrequency.opt3"]      = "Üle nädala",
            ["cleaningFrequency.opt4"]      = "Kord kuus",
            ["cleaningFrequency.opt5"]      = "Klient ei ole kindel",
            ["cleaningCondition.label"]     = "Mustuse aste",
            ["cleaningCondition.opt1"]      = "Tavaline hooldatud kodu",
            ["cleaningCondition.opt2"]      = "Pole ammu koristatud",
            ["cleaningCondition.opt3"]      = "Remondi- või ehitusjärgne",
            ["cleaningCondition.opt4"]      = "Klient ei ole kindel",
            ["cleaningHousehold.label"]     = "Kodus",
            ["cleaningHousehold.opt1"]      = "Lapsi ega loomi ei ole",
            ["cleaningHousehold.opt2"]      = "Väikesed lapsed",
            ["cleaningHousehold.opt3"]      = "Lemmikloomad",
            ["cleaningHousehold.opt4"]      = "Klient ei ole kindel",
        });
    ...
    private static readonly IReadOnlyDictionary<string, string> ScopeEn =
        WithSharedAccessChips(new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["vanrentalLicence.label"]      = "Licence held for",
            ["vanrentalLicence.opt1"]       = "Provisional licence (under 2 years)",
            ["vanrentalLicence.opt2"]       = "2–5 years",
            ["vanrentalLicence.opt3"]       = "Over 5 years",
            ["vanrentalLicence.opt4"]       = "The customer wants a driver — will not drive",
            ["vanrentalLicence.opt5"]       = "The customer is not sure",
            ...
            ["cleaningArea.label"]          = "Floor area",
            ["cleaningArea.opt1"]           = "Up to 40 m² (1 room)",
            ["cleaningArea.opt2"]           = "40–60 m² (2 rooms)",
            ["cleaningArea.opt3"]           = "60–80 m² (3 rooms)",
            ["cleaningArea.opt4"]           = "80–110 m² (4 rooms)",
            ["cleaningArea.opt5"]           = "110–150 m²",
            ["cleaningArea.opt6"]           = "Over 150 m² or a house",
            ["cleaningArea.opt7"]           = "The customer is not sure",
            ["cleaningFrequency.label"]     = "How often",
            ["cleaningFrequency.opt1"]      = "One-off clean",
            ["cleaningFrequency.opt2"]      = "Weekly",
            ["cleaningFrequency.opt3"]      = "Every two weeks",
            ["cleaningFrequency.opt4"]      = "Monthly",
            ["cleaningFrequency.opt5"]      = "The customer is not sure",
            ["cleaningCondition.label"]     = "Condition",
            ["cleaningCondition.opt1"]      = "Normal, well-kept home",
            ["cleaningCondition.opt2"]      = "Not cleaned in a long time",
            ["cleaningCondition.opt3"]      = "After renovation or building work",
            ["cleaningCondition.opt4"]      = "The customer is not sure",
            ["cleaningHousehold.label"]     = "In the home",
            ["cleaningHousehold.opt1"]      = "No children or pets",
            ["cleaningHousehold.opt2"]      = "Small children",
            ["cleaningHousehold.opt3"]      = "Pets",
            ["cleaningHousehold.opt4"]      = "The customer is not sure",
        });
    ...
    private static readonly IReadOnlyDictionary<string, string> ScopeRu =
        WithSharedAccessChips(new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["vanrentalLicence.label"]      = "Стаж вождения",
            ["vanrentalLicence.opt1"]       = "Начальные права (менее 2 лет)",
            ["vanrentalLicence.opt2"]       = "2–5 лет",
            ["vanrentalLicence.opt3"]       = "Более 5 лет",
            ["vanrentalLicence.opt4"]       = "Клиент берёт с водителем — сам не поедет",
            ["vanrentalLicence.opt5"]       = "Клиент не уверен",
            ...
            ["cleaningArea.label"]          = "Площадь",
            ["cleaningArea.opt1"]           = "До 40 м² (1 комната)",
            ["cleaningArea.opt2"]           = "40–60 м² (2 комнаты)",
            ["cleaningArea.opt3"]           = "60–80 м² (3 комнаты)",
            ["cleaningArea.opt4"]           = "80–110 м² (4 комнаты)",
            ["cleaningArea.opt5"]           = "110–150 м²",
            ["cleaningArea.opt6"]           = "Более 150 м² или дом",
            ["cleaningArea.opt7"]           = "Клиент не уверен",
            ["cleaningFrequency.label"]     = "Как часто",
            ["cleaningFrequency.opt1"]      = "Разовая уборка",
            ["cleaningFrequency.opt2"]      = "Раз в неделю",
            ["cleaningFrequency.opt3"]      = "Раз в две недели",
            ["cleaningFrequency.opt4"]      = "Раз в месяц",
            ["cleaningFrequency.opt5"]      = "Клиент не уверен",
            ["cleaningCondition.label"]     = "Степень загрязнённости",
            ["cleaningCondition.opt1"]      = "Обычный ухоженный дом",
            ["cleaningCondition.opt2"]      = "Давно не убирали",
            ["cleaningCondition.opt3"]      = "После ремонта или стройки",
            ["cleaningCondition.opt4"]      = "Клиент не уверен",
            ["cleaningHousehold.label"]     = "В доме",
            ["cleaningHousehold.opt1"]      = "Нет детей и животных",
            ["cleaningHousehold.opt2"]      = "Маленькие дети",
            ["cleaningHousehold.opt3"]      = "Домашние животные",
            ["cleaningHousehold.opt4"]      = "Клиент не уверен",
        });
    ...
    private static readonly IReadOnlyDictionary<string, string> ScopeLv =
        WithSharedAccessChips(new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["vanrentalLicence.label"]      = "Vadītāja apliecības stāžs",
            ["vanrentalLicence.opt1"]       = "Sākuma apliecība (mazāk par 2 gadiem)",
            ["vanrentalLicence.opt2"]       = "2–5 gadi",
            ["vanrentalLicence.opt3"]       = "Vairāk par 5 gadiem",
            ["vanrentalLicence.opt4"]       = "Klients ņem ar šoferi — pats nebrauks",
            ["vanrentalLicence.opt5"]       = "Klients nav pārliecināts",
            ...
            ["cleaningArea.label"]          = "Platība",
            ["cleaningArea.opt1"]           = "Līdz 40 m² (1 istaba)",
            ["cleaningArea.opt2"]           = "40–60 m² (2 istabas)",
            ["cleaningArea.opt3"]           = "60–80 m² (3 istabas)",
            ["cleaningArea.opt4"]           = "80–110 m² (4 istabas)",
            ["cleaningArea.opt5"]           = "110–150 m²",
            ["cleaningArea.opt6"]           = "Vairāk nekā 150 m² vai māja",
            ["cleaningArea.opt7"]           = "Klients nav pārliecināts",
            ["cleaningFrequency.label"]     = "Cik bieži",
            ["cleaningFrequency.opt1"]      = "Vienreizēja uzkopšana",
            ["cleaningFrequency.opt2"]      = "Reizi nedēļā",
            ["cleaningFrequency.opt3"]      = "Reizi divās nedēļās",
            ["cleaningFrequency.opt4"]      = "Reizi mēnesī",
            ["cleaningFrequency.opt5"]      = "Klients nav pārliecināts",
            ["cleaningCondition.label"]     = "Netīrības pakāpe",
            ["cleaningCondition.opt1"]      = "Parasts, kopts mājoklis",
            ["cleaningCondition.opt2"]      = "Sen nav uzkopts",
            ["cleaningCondition.opt3"]      = "Pēc remonta vai būvdarbiem",
            ["cleaningCondition.opt4"]      = "Klients nav pārliecināts",
            ["cleaningHousehold.label"]     = "Mājoklī",
            ["cleaningHousehold.opt1"]      = "Nav bērnu un dzīvnieku",
            ["cleaningHousehold.opt2"]      = "Mazi bērni",
            ["cleaningHousehold.opt3"]      = "Mājdzīvnieki",
            ["cleaningHousehold.opt4"]      = "Klients nav pārliecināts",
        });
    ...
    private static readonly IReadOnlyDictionary<string, string> ScopeLt =
        WithSharedAccessChips(new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["vanrentalLicence.label"]      = "Vairuotojo stažas",
            ["vanrentalLicence.opt1"]       = "Pradinis pažymėjimas (mažiau nei 2 metai)",
            ["vanrentalLicence.opt2"]       = "2–5 metai",
            ["vanrentalLicence.opt3"]       = "Daugiau nei 5 metai",
            ["vanrentalLicence.opt4"]       = "Klientas ima su vairuotoju — pats nevairuos",
            ["vanrentalLicence.opt5"]       = "Klientas nėra tikras",
            ...
            ["cleaningArea.label"]          = "Plotas",
            ["cleaningArea.opt1"]           = "Iki 40 m² (1 kambarys)",
            ["cleaningArea.opt2"]           = "40–60 m² (2 kambariai)",
            ["cleaningArea.opt3"]           = "60–80 m² (3 kambariai)",
            ["cleaningArea.opt4"]           = "80–110 m² (4 kambariai)",
            ["cleaningArea.opt5"]           = "110–150 m²",
            ["cleaningArea.opt6"]           = "Daugiau nei 150 m² arba namas",
            ["cleaningArea.opt7"]           = "Klientas nėra tikras",
            ["cleaningFrequency.label"]     = "Kaip dažnai",
            ["cleaningFrequency.opt1"]      = "Vienkartinis valymas",
            ["cleaningFrequency.opt2"]      = "Kartą per savaitę",
            ["cleaningFrequency.opt3"]      = "Kas dvi savaites",
            ["cleaningFrequency.opt4"]      = "Kartą per mėnesį",
            ["cleaningFrequency.opt5"]      = "Klientas nėra tikras",
            ["cleaningCondition.label"]     = "Užterštumo laipsnis",
            ["cleaningCondition.opt1"]      = "Įprastas, prižiūrimas būstas",
            ["cleaningCondition.opt2"]      = "Seniai nevalyta",
            ["cleaningCondition.opt3"]      = "Po remonto ar statybų",
            ["cleaningCondition.opt4"]      = "Klientas nėra tikras",
            ["cleaningHousehold.label"]     = "Namuose",
            ["cleaningHousehold.opt1"]      = "Nėra vaikų ir gyvūnų",
            ["cleaningHousehold.opt2"]      = "Maži vaikai",
            ["cleaningHousehold.opt3"]      = "Augintiniai",
            ["cleaningHousehold.opt4"]      = "Klientas nėra tikras",
        });
