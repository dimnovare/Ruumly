    ...
    public async Task<PricingConfig> GetAsync()
    {
        ...
        var config = new PricingConfig(
            ...
            Starter: new TierConfig(
                ...
                MaxActiveUnits:        I("tier.starter.maxActiveUnits",   5),
            ...
            Standard: new TierConfig(
                ...
                MaxLocations:          I("tier.standard.maxLocations",     3),
                MaxActiveUnits:        I("tier.standard.maxActiveUnits",   20),
                MaxExtras:             I("tier.standard.maxExtras",        10),
                CanHavePromotedBadge:  false,
            ...
            Premium: new TierConfig(
                ...
                MaxLocations:          I("tier.premium.maxLocations",     10),
                MaxActiveUnits:        I("tier.premium.maxActiveUnits",   50),
