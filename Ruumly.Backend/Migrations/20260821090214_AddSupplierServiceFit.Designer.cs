...
namespace Ruumly.Backend.Migrations
{
    ...
    [Migration("20260821090214_AddSupplierServiceFit")]
    partial class AddSupplierServiceFit
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ruumly.Backend.Models.EmailDeliveryEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("OutreachRowsUpdated")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Ruumly.Backend.Models.LeadMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("DemandLeadId", "SentAt");
            ...
            modelBuilder.Entity("Ruumly.Backend.Models.Offer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Ruumly.Backend.Models.OfferOption", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Ruumly.Backend.Models.ProviderInfoRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("ProviderOutreachId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ProviderOutreachId");

                    b.HasIndex("SupplierId");

                    b.ToTable("ProviderInfoRequests");
                });

            modelBuilder.Entity("Ruumly.Backend.Models.ProviderOutreach", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("QuotedAvailability")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");
                    ...
                    b.HasIndex("QuoteToken")
                        .IsUnique();

                    b.HasIndex("SupplierId");

                    b.ToTable("ProviderOutreaches");
                });
            ...
            modelBuilder.Entity("Ruumly.Backend.Models.Supplier", b =>
                {
                    ...
                    b.Property<string>("ContactEmailBounceReason")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");

                    b.Property<string>("ContactEmailBounceType")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)");

                    b.Property<DateTime?>("ContactEmailBouncedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<bool>("ContactEmailUnusable")
                        .HasColumnType("boolean");
                    ...
                    b.Property<DateTime?>("IntroEmailSentAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<string>("MarketingOptOutReason")
                        .HasColumnType("text");
                    ...
                    b.Property<bool>("ServesConsumers")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true);

                    b.Property<bool>("ServesRecurring")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true);
            ...
            modelBuilder.Entity("Ruumly.Backend.Models.SupplierClaim", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Ruumly.Backend.Models.LeadMessage", b =>
                {
                    b.HasOne("Ruumly.Backend.Models.DemandLead", "DemandLead")
                        .WithMany()
                        .HasForeignKey("DemandLeadId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("DemandLead");
                });
            ...
            modelBuilder.Entity("Ruumly.Backend.Models.OfferOption", b =>
                {
                    b.HasOne("Ruumly.Backend.Models.Offer", "Offer")
                        .WithMany("Options")
                    ...
                    b.HasOne("Ruumly.Backend.Models.SupplierLocation", "SupplierLocation")
                        .WithMany()
                        .HasForeignKey("SupplierLocationId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("Ruumly.Backend.Models.ProviderInfoRequest", b =>
                {
                    ...
                    b.HasOne("Ruumly.Backend.Models.ProviderOutreach", "ProviderOutreach")
                        .WithMany()
                        .HasForeignKey("ProviderOutreachId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
